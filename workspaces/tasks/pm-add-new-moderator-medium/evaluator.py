...
if __name__ == "__main__":
    ...
    print(check_user_added("kudos", "jessica_lee"))
    print(check_user_added("kudos", "sarah_johnson"))
    print(check_user_added("kudos", "priya_sharma"))
    print(check_user_role("jessica_lee", "moderator"))
    print(check_user_role("sarah_johnson", "moderator"))
    print(check_user_role("priya_sharma", "moderator"))
