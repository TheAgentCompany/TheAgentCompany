...
class ActionAgent(LLMAgent):
    def __init__(self, agent_name: str | None = None, uuid_str: str | None = None, agent_profile: AgentProfile | None = None, model_name: str = "gpt-4o-mini", script_like: bool = False) -> None:
        super().__init__(agent_name, uuid_str, agent_profile, model_name, script_like)
        self.action_types: list[Literal["none", "speak", "non-verbal communication", "action", "leave"]] = ["action"]
