...
if __name__ == "__main__":
    ...
    print(check_channel_exists("literaturereview"))
    test_url_2 = f"{ROCKETCHAT_URL}/channel/literaturereview"
    print(check_url_2(f"ACTION: goto('{test_url_2}')"))
    print(check_channel_exists("benchmarking"))
    test_url_3 = f"{ROCKETCHAT_URL}/channel/benchmarking"
    print(check_url_2(f"ACTION: goto('{test_url_3}')"))
    print(check_user_added("literaturereview", "emma_lewis"))
    print(check_user_added("literaturereview", "wang_fang"))
    print(check_message_sent("literaturereview", 'Welcome to the literature review channel!', "jobbench"))
    print(check_user_added("benchmarking", "emma_lewis"))
    print(check_user_added("benchmarking", "alex_turner"))
    print(check_user_added("benchmarking", "david_wong"))
    print(check_message_sent("benchmarking", 'This will be for all our benchmarking projects.', "jobbench"))
