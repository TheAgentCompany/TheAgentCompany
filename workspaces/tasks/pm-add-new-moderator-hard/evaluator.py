...
if __name__ == "__main__":
    ...
    print(check_channel_exists("kudos"))
    test_url_2 = f"{ROCKETCHAT_URL}/channel/kudos"
    print(check_url_2(f"ACTION: goto('{test_url_2}')"))
    test_url_3 = f"{ROCKETCHAT_URL}/channel/general"
    print(check_url_2(f"ACTION: goto('{test_url_3}')"))
    print(check_user_added("kudos", "John.Doe"))
    print(check_user_added("kudos", "li_ming"))
    print(check_user_role("John.Doe", "moderator"))
    print(check_user_role("li_ming", "moderator"))
    print(check_user_added("general", "jessica_lee"))
    print(check_user_added("general", "sarah_johnson"))
    print(check_user_role("huang_jie", "moderator"))
    print(check_user_role("emma_lewis", "moderator"))
