...
TEST_REPO_NAME="janusgraph"
TEST_REPO_NAME_2="colly"
TEST_REPO_NAME_3="streamlit"
...
def test_pull_repository_2():
    execute_command(f"rm -rf {TEST_REPO_NAME_2}")
    execute_command(f"git clone {GITLAB_URL}/{TEST_REPO_NAME_2}.git")
    return

def test_pull_repository_3():
    execute_command(f"rm -rf {TEST_REPO_NAME_2}")
    execute_command(f"git clone {GITLAB_URL}/{TEST_REPO_NAME_3}.git")
    return
