...
def get_config(
    ...
    config = AppConfig(
        ...
        workspace_mount_path=trajectories_path,
        workspace_mount_path_in_sandbox='/trajectories',
    )
...
def init_task_env(runtime: Runtime, openai_api_key: str):
    action = CmdRunAction(command=f'SERVER_HOSTNAME={ogma.lti.cs.cmu.edu} OPENAI_API_KEY={openai_api_key} bash /utils/init.sh')
    logger.info(action, extra={'msg_type': 'ACTION'})
...
if __name__ == '__main__':
    ...
    trajectory_path = f'/trajectories/{args.task_image_name}.json'
